...
class _ProficiencyScreenState extends ConsumerState<ProficiencyScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final levels = [
      _LevelOption(code: 'A1', name: l10n.onboarding_proficiencyBeginner, desc: l10n.onboarding_proficiencyBeginnerDesc),
      _LevelOption(code: 'A2', name: l10n.onboarding_proficiencyElementary, desc: l10n.onboarding_proficiencyElementaryDesc),
      _LevelOption(code: 'B1', name: l10n.onboarding_proficiencyIntermediate, desc: l10n.onboarding_proficiencyIntermediateDesc),
      _LevelOption(code: 'B2', name: l10n.onboarding_proficiencyUpperIntermediate, desc: l10n.onboarding_proficiencyUpperIntermediateDesc),
      _LevelOption(code: 'C1', name: l10n.onboarding_proficiencyAdvanced, desc: l10n.onboarding_proficiencyAdvancedDesc),
      _LevelOption(code: 'C2', name: l10n.onboarding_proficiencyProficient, desc: l10n.onboarding_proficiencyProficientDesc),
    ];
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                l10n.profile_stepXofY(ref.watch(onboardingDataProvider).learningGoal == LearningGoal.exam ? 5 : 4, ref.watch(onboardingDataProvider).totalSteps),
                style: TextStyle(
                  fontSize: 11.sp,
              ...
              SizedBox(height: 6.h),
              Text(
                l10n.onboarding_proficiencyTitle,
              ...
              Text(
                l10n.onboarding_proficiencySubtitle,
