...
class _MotivationScreenState extends ConsumerState<MotivationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final options = [
      _MotivationOption(id: 'work', label: l10n.onboarding_motivationCareer, icon: PhosphorIcons.briefcase()),
      _MotivationOption(id: 'travel', label: l10n.onboarding_motivationTravel, icon: PhosphorIcons.airplaneTilt()),
      _MotivationOption(id: 'study', label: l10n.onboarding_motivationStudyAbroad, icon: PhosphorIcons.student()),
      _MotivationOption(id: 'culture', label: l10n.onboarding_motivationCulture, icon: PhosphorIcons.globe()),
      _MotivationOption(id: 'family', label: l10n.onboarding_motivationFamily, icon: PhosphorIcons.users()),
      _MotivationOption(id: 'fun', label: l10n.onboarding_motivationFun, icon: PhosphorIcons.gameController()),
      _MotivationOption(id: 'brain', label: l10n.onboarding_motivationBrainTraining, icon: PhosphorIcons.brain()),
      _MotivationOption(id: 'media', label: l10n.onboarding_motivationMoviesShows, icon: PhosphorIcons.filmStrip()),
    ];
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                l10n.profile_stepXofY(ref.watch(onboardingDataProvider).learningGoal == LearningGoal.exam ? 6 : 5, ref.watch(onboardingDataProvider).totalSteps),
                style: TextStyle(
                  fontSize: 11.sp,
              ...
              Text(
                l10n.onboarding_motivationSubtitle,
