        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(l10n.onboardingGoalHint, style: theme.textTheme.bodyLarge?.copyWith(color: context.appTheme.onSurfaceVariant)),
              SizedBox(height: 32.h),
              _GoalCard(
                icon: PhosphorIcon(PhosphorIcons.trophy(PhosphorIconsStyle.fill)),
                title: l10n.onboardingGoalExamTitle,
                subtitle: l10n.onboardingGoalExamSubtitle,
              ...
              _GoalCard(
                ...
                title: l10n.onboardingGoalFunTitle,
                subtitle: l10n.onboardingGoalFunSubtitle,
